  ...
  <div class="modal-dialog modal-lg" role="dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title text-info text-center" ><b>Detail Lokasi</b></h4>
      </div>
      <div class="modal-body text-center">
        <form id="form_view" method="post">
          ...
          <div class="modal-footer button-group text-center clear" id="button">
            <button type="button" class="btn btn-warning" data-dismiss="modal" style="margin-top:45px !important;">Keluar</button>
          </div>
        </div>
      </div>
    </div>
